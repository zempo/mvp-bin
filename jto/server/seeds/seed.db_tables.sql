...
INSERT INTO jto_users (admin, user_name, full_name, email, password)
    VALUES
    (TRUE, 'the_card_czar', 'Solomon Zelenko', 'support@solomonzelenko.dev', '$2a$12$LmhZa3hpJxuvCRxJVyOWA./y8/g2/zVkJZT2s1zpODoOYTlIow.HW'),
    (default, 'greet-expectations', 'Mike Man', 'jenglish@uk.gov', '$2a$12$iwgQq21mmh93/G4pNOg33OwtLM6qaZjBOjKpFJMKIqfkLuiVbtuQS'),
    (default, 'mindy-city', 'Mindy Momo', 'mmomo@gmail.com', '$2a$12$RyFNN9oTauozyfe64E28Tu3EkjKPfkDo9EzMj29xCY6EKFdDNCIi2');

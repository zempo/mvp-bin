...
export const projects = [
  {
    ...
    screenshot_captions: [`Map of police misconduct (Blue Witness).`,
  ...
  },
  {
    ...
    *NOTE: At the time of this writing, I am implementing new features for this project.*
    ...
    screenshot_captions: [`Desktop view (Beampocket).`,
  ...
  },
  {
    ...
    screenshot_captions: [`Desktop view (Above the Line).`
  ...
  },
  {
    ...
    screenshot_captions: [`Desktop view (Just the Occasion).`
  ...
  },
  {
    ...
    screenshot_captions: [`Desktop view (Portfolio).`,
